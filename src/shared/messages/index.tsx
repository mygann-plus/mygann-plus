...
function handleButtonClick(e: MouseEvent, messageElem: HTMLElement, callback: Function) {
  e.preventDefault();
...
interface AddMessageBarButtonParams {
  buttonText: string,
  messageText: string,
...
export async function addMessageBarButton(params: AddMessageBarButtonParams) {
  const { buttonText, messageText, onClick, id } = params;
