...
export function appendDesktopUserMenuElem(elem: Node) {
...
export function appendDesktopUserMenuLink(title: string, onClick: Function) {
...
export function appendMobileUserMenuLink(title: string, onClick: Function) {
  const handleClick = (e: any) => {
    e.preventDefault();
